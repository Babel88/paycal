...
//
//        return new DefaultTypicalWithholdingTaxPayment(parameters());
//
//    }
...
//    @Bean
//    public PartialTaxPaymentLogic partialTaxPaymentLogic(){
//
//        return new DefaultPartialTaxPaymentLogic(parameters());
//    }
...
//    @Bean
//    public DefaultPrepayable defaultPrepaymentImpl(){
//
//        return new DefaultPrepayment(parameters());
//    }
//
//    @Bean
//    public DefaultPrepayable defaultPrepayment(){
//
//        return defaultPrepaymentImpl();
//    }
