...
public class InclusiveTTControllerImplTest {
    ...
    public void setUp() throws Exception {
        ...
        when(invoiceDetails.exclusiveOfWithholdingTax()).thenReturn(false);
        ...
        when(ttArguments.getTaxExclusionPolicy()).thenReturn(false);
    ...
    public void runCalculationWithholdingTax() throws Exception {
        ...
        assertEquals(bd(9073.11),withholdingTax);
    }
    ...
    public void runCalculationWithholdingVat() throws Exception {
        ...
        assertEquals(bd(7258.49),withholdingVat);
    }
    ...
    public void runCalculationTotalExpenses() throws Exception {
        ...
        assertEquals(bd(52624.05),totalExpense);
    }
    ...
    public void runCalculationToPayee() throws Exception {
        ...
        assertEquals(bd(36292.45),toPayee);
    }
